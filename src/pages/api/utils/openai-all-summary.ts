...
export const extractAllSummary = async (
  intervieweeInformations: any,
  answerResult: any,
  ...
  let prompt = `You are to generate a summary for interview result.\n
    ...
    The information of interviewees is ${intervieweeInformations}.\n
  ...
  while (attempt < maxAttempts && !success) {
    try {
      ...
      selectedInterviewSheet.interviewSummary = res;
